...
[cols=",,",options="header"]
|===
a| image:camera/share-from-camera-owncloud-android-app-step-1.png[Uploading pictures directly from the camera in the ownCloud Android app, steps 1, width=80%,pdfwidth=45%]
a| image:camera/share-from-camera-owncloud-android-app-step-2.png[Uploading pictures directly from the camera in the ownCloud Android app, steps 2, width=80%,pdfwidth=45%]
a| image:camera/share-from-camera-owncloud-android-app-step-3.jpg[Uploading pictures directly from the camera in the ownCloud Android app, steps 3, width=80%,pdfwidth=45%]
|===
